...
const prisma = new estoque_client_1.PrismaClient();
async function main() {
    ...
    for (const table of tablenames) {
        try {
            await prisma.$executeRawUnsafe(`TRUNCATE TABLE "estoque"."${table}" RESTART IDENTITY CASCADE;`);
        }
        catch (error) {
...
//# sourceMappingURL=seed-estoque.js.map